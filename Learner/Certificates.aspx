<%@ Page Title="My Certificates" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Certificates.aspx.cs" Inherits="LearnerDash.Learner.Certificates" %>
        ...
        <ItemTemplate>
            <div class="card shadow-sm mb-3" style="border-radius:10px;">
                <div class="card-body p-4 d-flex justify-content-between align-items-center">
                    ...
                    <%-- Download link — disabled if PdfPath is null --%>
