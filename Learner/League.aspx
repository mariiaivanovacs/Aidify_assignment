<%@ Page Title="League" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="League.aspx.cs" Inherits="LearnerDash.Learner.League" %>
                    ...
                    <asp:Repeater ID="rptLeaderboard" runat="server">
                        <ItemTemplate>
                            <tr class='<%# Convert.ToBoolean(Eval("IsCurrentUser")) ? "table-warning" : "" %>'>
                                ...
                                <td><%# Eval("FullName") %></td>
                                <td>
                                    <span class='badge <%# ((LearnerDash.Learner.League)Page).GetTierBadge(Eval("Tier").ToString()) %>'>
                                        <%# Eval("Tier") %>
                                    </span>
                                </td>
